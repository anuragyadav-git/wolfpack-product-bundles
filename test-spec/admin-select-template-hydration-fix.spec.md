...
type: test-spec
status: active
summary: Verifies projected template dialogs follow app state and the Admin document hydrates without a mutable font resource.
...
- [x] FPB and PPB Select Template actions open their projected dialogs.
