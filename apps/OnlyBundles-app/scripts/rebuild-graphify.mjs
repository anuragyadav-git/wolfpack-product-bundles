...
const { findRepositoryRoot } = require('./lib/repository-layout.cjs');
const {
...
const repositoryRoot = findRepositoryRoot(fileURLToPath(import.meta.url));
const graphPath = `${repositoryRoot}/graphify-out/graph.json`;
