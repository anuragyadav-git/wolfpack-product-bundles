          ...
          <div className={brandStyles.cardShell}>
            <s-stack direction="block" gap="large">
              <s-stack direction="block" gap="small-100">
                ...
                >
                  ...
                  <span className={brandStyles.muted}>
              ...
              <s-stack direction="block" gap="small">
                <p className={brandStyles.featureHeading}>
                  {t("billing.cards.growthIncludes")}
                </p>
                <s-stack direction="block" gap="small-100">
                  {PLANS.growth.featureMessageIds.map((messageId, index) => (
                    ...
                    >
                      ...
                      <span
                        className={`${brandStyles.feature} ${
                          index < 4 ? brandStyles.featured : ""
                        }`}
                      >
                        {t(messageId)}
                      </span>
            ...
            <div className={brandStyles.actions}>
              <s-stack direction="block" gap="small-100">
                {!isCurrentPlan && (
                  <p className={brandStyles.finePrint}>
                    {t("billing.cards.trialAndBilling", {
                      days: PLANS.growth.trialDays,
                    })}
                  </p>
                )}
                <s-button
