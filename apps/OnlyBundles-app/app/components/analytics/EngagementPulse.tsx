  ...
  return (
    <section className="wpb-card" aria-labelledby="wpb-engagement-pulse-title">
      <header className="wpb-section-header">
        <h2 id="wpb-engagement-pulse-title" className="wpb-section-title">
          {translateAdmin(
            "adminExtracted.components.analytics.engagementpulse.engagementPulse"
          )}
        </h2>
        <p className="wpb-section-hint">
          {translateAdmin(
            "adminExtracted.components.analytics.engagementpulse.preCheckoutSignal"
          )}
        </p>
      </header>
      ...
      <div className="wpb-two-column-grid">
        <KpiTile
          label={translateAdmin("analyticsPage.offers.engaged")}
        ...
        />
        <KpiTile
          label={translateAdmin("adminAttributes.engagedCheckout")}
          value={
            engagementToOrderPct === null ? "—" : `${engagementToOrderPct}%`
          }
          accent="engagement"
          ...
          >
            ...
            <YAxis
              ...
              tickFormatter={(value: number) =>
                formatCompactCountAxisTick(value)
              }
              width={42}
            />
            <Tooltip
              ...
              ) => [Number(value ?? 0).toLocaleString(), "engagements"]}
            />
            <Area
              type="monotone"
              dataKey="engagements"
