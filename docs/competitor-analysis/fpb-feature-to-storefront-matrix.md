...
| D09 | F3 | Discount messaging off/on | Message visibility follows its own saved control | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL |
| D10 | F3 | Variables and custom copy | Remaining quantity/amount, value/unit, and discounted-item variables resolve | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL |
...
| G19 | F3 | Bundle footer condition/discount messaging | Footer copy and visibility follow their independent saved controls | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL |
