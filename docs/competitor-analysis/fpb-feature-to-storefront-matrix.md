...
| R15 | F6 | Step/category banner media | Saved desktop/mobile media renders at the EB-owned stage | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
| R16 | F8 | First load and cache-bypassed reload | No wrong-preset flash; restored fixture renders identically | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
...
| M03 | F4 | Product Slots disabled | Summary uses the EB text/row branch | **P** F4-SLOTS-OFF | **P** F4-SLOTS-OFF | **P** F4-SLOTS-OFF | **P** F4-SLOTS-OFF |
| M04 | F4 | Product Slots enabled | Summary uses empty/filled image slots based on quantity rules | **P** F4-SLOTS-ALL | **P** F4-SLOTS-ALL | **P** F4-SLOTS-ALL | **P** F4-SLOTS-ALL |
| M05 | F4 | Custom slot icon | Merchant slot icon replaces the default plus only where applicable | **E** F4-SLOTS-ALL | **E** F4-SLOTS-ALL | **E** F4-SLOTS-ALL | **E** F4-SLOTS-ALL |
| M06 | F4 | Empty/partial/complete slot states | Slot count and fill state follow the saved condition | **P** F4-SLOTS-ALL | **P** F4-SLOTS-ALL | **P** F4-SLOTS-ALL | **P** F4-SLOTS-ALL |
| M07 | F0 | Mobile tray collapsed | Count, CTA, price, and qualification remain readable | **P** F0-MOBILE-TOGGLE | **P** F0-MOBILE-TOGGLE | **P** F0-MOBILE-TOGGLE | **P** F0-MOBILE-TOGGLE |
| M08 | F0 | Mobile tray expanded | Selected rows/slots, remove actions, messages, and totals remain reachable | **P** F0-MOBILE-TOGGLE | **P** F0-MOBILE-TOGGLE | **P** F0-MOBILE-TOGGLE | **P** F0-MOBILE-TOGGLE |
| M09 | F8 | Tray scroll and background behavior | Sticky/expanded behavior matches EB without viewport overflow | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| M10 | F4 | Bundle Quantity Options disabled/enabled | Box/tier selection appears only when saved and changes the active target | **P** F4-BOX-ALL | **P** F4-BOX-ALL | **P** F4-BOX-ALL | **P** F4-BOX-ALL |
| M11 | F4 | Box underfill/exact/overfill | Add and cart actions enforce the selected box quantity | **P** F4-BOX-ALL | **P** F4-BOX-ALL | **P** F4-BOX-ALL | **P** F4-BOX-ALL |
| M12 | F4 | Box/tier switch with existing selections | EB-prescribed selection retention/reset and totals are mirrored | **P** F4-BOX-ALL | **P** F4-BOX-ALL | **P** F4-BOX-ALL | **P** F4-BOX-ALL |
...
| D03 | F3 | Fixed amount off | Quantity/amount threshold and totals match EB | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL |
| D04 | F3 | Fixed bundle price | Display, totals, and cart result match EB | **P** F3-FIXED-PRICE-ALL | **P** F3-FIXED-PRICE-ALL | **P** F3-FIXED-PRICE-ALL | **P** F3-FIXED-PRICE-ALL |
| D05 | F3 | Buy X, Get Y | Buy/get threshold, discounted-item choice, copy, and cart result match EB | **P** F3-BOGO-STEP-ALL | **P** F3-BOGO-STEP-ALL | **P** F3-BOGO-STEP-ALL | **P** F3-BOGO-STEP-ALL |
| D06 | F3 | Amount-based discount threshold | Currency threshold and remaining amount text match EB | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL |
...
| D08 | F3 | Progress off/simple/step-based | Each saved presentation mode renders independently | **P** F3-BOGO-STEP-ALL | **P** F3-BOGO-STEP-ALL | **P** F3-BOGO-STEP-ALL | **P** F3-BOGO-STEP-ALL |
| D09 | F3 | Discount messaging off/on | Message visibility follows its own saved control | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL | **P** F3-FIXED-AMOUNT-SIMPLE-ALL, F3-SHARED-MOBILE-FOOTER | **P** F3-FIXED-AMOUNT-SIMPLE-ALL, F3-SHARED-MOBILE-FOOTER |
...
| D13 | F6 | Multi-language discount/progress labels | Active locale selects the correct saved labels without fallback copy | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |

## 6. Add-Ons, Free Gifts, and Personalization

| ID | Group | Feature / state | EB storefront contract | ST | CL | CO | HO |
| --- | --- | --- | --- | --- | --- | --- | --- |
| A01 | F5 | Add-ons disabled | No add-on stage, tier, or message leaks into the shopper flow | **P** F5-DISABLED-ALL | **P** F5-DISABLED-ALL | **P** F5-DISABLED-ALL | **P** F5-DISABLED-ALL |
| A02 | F5 | Gifting step only | Gifting stage appears in the configured sequence | **P** F5-GIFTING-ONLY-ALL | **P** F5-GIFTING-ONLY-ALL | **P** F5-GIFTING-ONLY-ALL | **P** F5-GIFTING-ONLY-ALL |
| A03 | F5 | Paid add-on tier | Eligible shopper can add the paid add-on at the configured price | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL |
| A04 | F5 | Free/100% add-on tier | Eligible item becomes free at the configured threshold | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL |
...
| A07 | F5 | Add-on product variants | Variant identity and price survive add/remove and cart add | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL |
| A08 | F5 | Add-on step navigation | Back/Next preserves core selections and add-on state | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL |
| A09 | F5 | Free-gift/sidebar presentation | Gift appears at the EB-owned summary/footer position | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL |
| A10 | F5 | Personalization fields | Configured field types, required validation, and values reach cart metadata | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X |
| A11 | F5 | Shopper messages | Configured message controls render, validate, and persist | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X |
| A12 | F5 | Email capture | Optional/required behavior and captured value match EB | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X | **X** F5-GIFT-MESSAGES-X |
| A13 | F5 | Add-on custom copy/locales | Active locale controls add-on/gift labels and validation | **E** F5-ADDON-LOCALES-E | **E** F5-ADDON-LOCALES-E | **E** F5-ADDON-LOCALES-E | **E** F5-ADDON-LOCALES-E |
| A14 | F7 | Add-on cart pricing and metadata | Paid/free pricing, offer IDs, and line properties survive checkout | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| A15 | F5 | Sidebar add-on/upsell slot | Configured upsell appears only at the EB-owned summary stage and does not displace core selections | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL | **P** F5-VARIANTS-NAV-ALL |
...
| S03 | F4 | Valid default product/variant | Valid defaults initialize once and synchronize summary/card state | **P** F4-DEFAULTS-ALL | **P** F4-DEFAULTS-ALL | **P** F4-DEFAULTS-ALL | **P** F4-DEFAULTS-ALL |
| S04 | F4 | Invalid/unavailable default | Invalid defaults are ignored or recovered without blocking load | **P** F4-INVALID-DEFAULT-ALL | **P** F4-INVALID-DEFAULT-ALL | **P** F4-INVALID-DEFAULT-ALL | **P** F4-INVALID-DEFAULT-ALL |
| S05 | F8 | Reload/session persistence | EB-defined selections persist/reset after hard reload exactly as captured | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| S06 | F7 | Blocked Add to Cart | Invalid bundle shows EB feedback and sends no cart request | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| S07 | F7 | Successful Add to Cart | Qualified bundle reaches cart/checkout once | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| S08 | F7 | Cart line properties | Bundle, step, category, variant, personalization, and add-on identity are correct | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| S09 | F7 | `bundle_details` cart metafield | Existing values merge and the current offer entry is complete | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| S10 | F7 | Discount transform result | Cart/checkout prices and savings match the qualified storefront state | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| S11 | F7 | Track inventory on Add to Cart | Cart-time inventory recheck follows the saved control | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| S12 | F7 | Redirect mode | Side-cart/default, cart, and checkout outcomes follow the saved mode | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| S13 | F7 | Execute script lifecycle | Saved Landing Page script runs once at the EB-defined lifecycle | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
...
| G02 | F6 | CTA and navigation copy | Add/Next/Back/Done/cart text uses saved long/localized copy | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
| G03 | F6 | Product-card copy | Add, selected, variant, quantity, remove, and sold-out labels use active locale | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
| G04 | F6 | Store-level language/locale | All shared and preset surfaces consume one active locale consistently | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
| G05 | F6 | Brand colors | Base colors propagate only to intended FPB surfaces | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
| G06 | F6 | Typography | Font family, weight, and scale propagate without theme leakage | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
| G07 | F6 | Corners and control shapes | Cards, buttons, pills/tabs, tray, and summary use saved tokens | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
| G08 | F6 | Expert color controls | Each control overrides only its owner surface | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
...
| G10 | F6 | Desktop/mobile banners | Correct viewport asset appears without layout shift or distortion | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN | **X** F6-DESIGN |
| G11 | F6 | Loading image/GIF | Saved loading media appears without wrong-preset/title flash | **P** CS5 | **P** CS5 | **P** CS5 | **P** CS5 |
...
| G16 | F7 | Inventory tracking control | Storefront selection/cart behavior follows the single saved source | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| G17 | F8 | Store header/footer visibility | Theme chrome is shown/hidden according to the FPB setting without displacing the widget | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
...
| G20 | F7 | Cart-line messaging | Saved bundle/cart message and active locale reach cart and checkout lines | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| G21 | F7 | Discount display format | Amount plus percentage, amount-only, and percentage-only formats follow the saved setting | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS | **P** F7-CART-CONTROLS |
| G22 | F8 | Bundle visibility and preview access | Active/unlisted public access and signed draft preview follow the persisted status without leaking drafts | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| G23 | F8 | App embed/page marker ownership | FPB mounts once from the supported marker path and does not duplicate the widget when both placement paths exist | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |

## 9. Responsive, Accessibility, Isolation, and Runtime Health

| ID | Group | Feature / state | EB storefront contract | ST | CL | CO | HO |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Q01 | F8 | Desktop `1440x900` and `1280x800` | Dense content remains aligned and reachable | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| Q02 | F8 | Tablet `768x1024` | Layout adapts without clipped cards, tabs, summary, or CTA | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| Q03 | F8 | Mobile `390x844` and `360x800` | Content and sticky tray fit the visual viewport | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
...
| Q06 | F8 | Keyboard access | Category, card, variant, summary, navigation, and cart controls are operable | **X** F8-QUALITY | **X** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| Q07 | F8 | Accessible names and state | Controls expose usable names, disabled/pressed/expanded state, and focus | **X** F8-QUALITY | **X** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| Q08 | F8 | Console and app-owned request health | No unexplained app-owned errors or failed widget/cart requests | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| Q09 | F8 | Responsive placement robustness | Content-driven CSS survives narrow/wide theme containers without store-specific constants | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
| Q10 | F8 | Cross-template regression | Shared fixes do not change unrelated FPB presets or PPB | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY | **P** F8-QUALITY |
...
| `F0-MOBILE-TOGGLE` | Fresh EB mobile proof at `390x844` established the summary toggle contract: one centered quantity pill shows an upward filled caret while collapsed and a downward caret while expanded. WPB previously reversed those directions, duplicated the icon across preset styles, omitted Horizontal ownership, rendered a second Classic-only toggle row, and used a narrower pseudo-element control. A final live replay found residual CSS drift: the shared pill could shrink below the EB-sized primitive, Standard, Classic, and Compact overrode the shared minimum with `max-content`, and CSS-owned tray transitions could snap or fight a reversed interaction. The source now holds every preset pill at a `48px` minimum, keeps the caret/toggle lifecycle at `300ms`, and animates measured tray and product-section heights for EB's approximately `700ms` footer motion. Cache-bypassed Classic replay on widget `5.0.222` confirmed the same focused button node remained connected through keyboard expansion and collapse, `aria-expanded` changed in place, and the footer moved between `115.2px` and `255.2px` without overflow. Served dev-tunnel CSS inspection confirmed Standard, Classic, and Compact no longer emit the conflicting `max-content` minimum. | Direct Chrome DevTools MCP accessibility, computed-style, resource, geometry, timing, network, and screenshot evidence from the 2026-07-30 sweep; `app/assets/widgets/full-page/methods/mobile-summary-methods.js`; `app/assets/widgets/full-page-css/base/sidebar-totals-discounts.css`; `app/assets/widgets/full-page-css/shared/mobile-summary-footer.css`; `app/assets/widgets/full-page-css/templates/side-footer-standard.css`; `app/assets/widgets/full-page-css/templates/side-footer-compact.css`; `app/assets/widgets/full-page-css/templates/classic/mobile.css`; `tests/unit/assets/fpb-standard-mobile-summary-action.test.ts`. |
| `F8-QUALITY` | EB and WPB Standard, Classic, Compact, and Horizontal were replayed at `1440x900`, `1280x800`, `768x1024`, `390x844`, and `360x800`. Every persisted preset loaded its matching runtime/CSS ownership with one widget root, retained theme containment and visibility/preview ownership, survived cache-bypassed reload, and kept document overflow at zero. Desktop, tablet, mobile tray, card-grid, tab-scroller, console, and app-owned request checks passed on WPB widget `5.0.222`; both fixtures were restored to Horizontal. EB Standard and Classic shopper controls remained non-semantic `div` interactions, while WPB intentionally preserves keyboard operation, names, state, and focus as an accessibility improvement, recorded as `X` rather than regressing to EB's limitation. | `/private/tmp/fpb-feature-parity/F8/runtime-summary.md`; direct Chrome DevTools MCP runtime/config, accessibility, computed-style, geometry, console, network, screenshot, and cache-bypassed reload evidence from 2026-07-30. |
...
| `F4-SLOTS-OFF` | EB and WPB Product Slots-disabled fixtures were cycled through Standard, Classic, Compact, and Horizontal at `1280x800` and `390x844`. Every preset used the selected-product row branch with one real selection, rendered no empty slot tiles, and had zero document overflow. WPB initially exposed a Classic-desktop-only gap because its Classic slot renderer ran unconditionally; widget `5.0.213` gates that branch on Product Slots and passed focused tests plus all-preset live replay. Active WPB widget/template assets returned `200`; console output contained only unrelated Shopify theme preload noise and one non-widget `404`. | Live Chrome DevTools MCP runtime/config, accessibility, geometry, console, and network capture on 2026-07-30; no raw artifact committed |
| `F4-SLOTS-ALL` | EB and WPB Product Slots-enabled fixtures were cycled through Standard, Classic, Compact, and Horizontal at `1280x800` and `390x844`. Each preset rendered three quantity-derived slots through empty, one-filled, and fully filled states without document overflow. EB persisted a custom slot image but every shopper preset continued to render its default empty-slot plus SVG, so custom slot-icon execution is terminal `E`; WPB did not fabricate the unsupported behavior. WPB served widget `5.0.212`. | Live Chrome DevTools MCP runtime/config, accessibility, and geometry capture on 2026-07-30; no raw artifact committed |
...
| `F3-FIXED-AMOUNT-SIMPLE-ALL` | EB and WPB were configured with a fixed amount discount at an amount threshold, simple progress, discount messaging, and custom success copy, then cycled through all four presets at desktop and mobile viewports. Qualified WPB summaries reused the shared footer/sidebar state and showed `$829.00 -> $814.00`; widget `5.0.209` fixed the shared qualification badge from the incorrect `2% off` to `$15.00 off` in every preset. The sweep also exposed and repaired the earlier bundled-widget declaration collision and shared mobile-progress visibility defect. Both fixtures were restored to Horizontal with percentage tiers `2 -> 10%` and `3 -> 20%`, progress disabled, messaging enabled, and original copy; the restored WPB runtime loaded widget `5.0.209` and the Horizontal preset asset. | `/private/tmp/fpb-feature-parity/F3/eb/fixed-amount/simple-progress/all-presets-delta.md`, `/private/tmp/fpb-feature-parity/F3/wpb/fixed-amount/simple-progress/widget-5.0.209-all-presets.md`, `tests/unit/assets/fpb-summary-discount-badge.test.ts`, `test-spec/fpb-summary-discount-badge.spec.md` |
| `F3-FIXED-PRICE-ALL` | EB and WPB were configured with one exact-quantity fixed bundle price rule, `2 products -> 1000`, progress disabled, and fixed-price messaging enabled, then cycled through Standard, Classic, Compact, and Horizontal at `1280x800` and `390x844`. Fresh EB evidence superseded the stale assumption that Classic and Compact desktop suppress success copy: both showed the success message, percentage badge, original total, and fixed total, while Horizontal retained its desktop omission and shared mobile success state. WPB widget `5.0.210` now uses the fixed total in every shared desktop/mobile summary, preserves the original total and computed percentage badge, and removes only the stale Classic/Compact desktop message-hiding overrides. The qualified Classic cart produced one transformed bundle line at `100000` cents with `165800` retail cents and `65800` savings cents. Both fixtures were restored cache-bypassed to Horizontal with percentage tiers `2 -> 10%` and `3 -> 20%`, progress disabled, messaging enabled, and WPB's exact step rule `1`. | Direct Chrome DevTools MCP snapshots, computed-style/runtime probes, and WPB cart JSON from the 2026-07-29 sweep; `tests/unit/assets/fpb-summary-discount-badge.test.ts`; `tests/unit/assets/fpb-sidebar-discount-progress.test.ts`; `tests/unit/assets/fpb-standard-mobile-summary-action.test.ts`; `test-spec/fpb-summary-discount-badge.spec.md`. |
| `F3-BOGO-STEP-ALL` | EB and WPB were configured with Buy X Get Y `buy 2 / get 1 at 100% off`, lowest-priced-item application, and step-based progress tier `Add 3 / 1 Product(s) @ 100% off`, then cycled through Standard, Classic, Compact, and Horizontal at `1280x800` and `390x844`. EB progressed through the zero/one/two/three-item messages and reached `Success! You got 1 product(s) at 100% off`; WPB matched the threshold arithmetic in every preset (`$1777.00 -> $1448.00`), kept the mobile tray within `390x844`, and produced a transformed checkout bundle with `$2606.00` retail, `$329.00` savings, and `$2277.00` final after the required second-step item. The served `5.0.210` asset incorrectly suppressed or substituted the qualified success copy. Widget `5.0.212` keeps success messages independent from tier labels and narrows Horizontal's desktop message suppression to fixed-bundle-price configurations. Current cache-bypassed Standard, Classic, Compact, and Horizontal desktop/mobile replays show the saved success copy alongside the step tier and the `$1448.00` final total; every mobile tray ends at `844px` with zero horizontal overflow. D08 is terminal because prior off/simple batches plus this direct step-based sweep prove all three saved presentation modes independently. WPB was restored to Horizontal after the replay; both fixtures remain on the BOGO step-based setup. | Direct Chrome DevTools MCP runtime, accessibility, geometry, and checkout probes from the 2026-07-29 sweep; `tests/unit/assets/template-manager.test.ts`; `tests/unit/assets/fpb-sidebar-discount-progress.test.ts`; `tests/unit/assets/fpb-standard-mobile-summary-action.test.ts`; `test-spec/fpb-summary-discount-badge.spec.md`. |
| `F3-SHARED-MOBILE-FOOTER` | WPB widget `5.0.207` moved the fluid Compact and Horizontal mobile footer structure into one shared stylesheet while retaining the existing shared renderer for header copy, Clear, slots, discount summary, and navigation. Cache-bypassed `390x844` replays confirmed Compact's empty expanded state and Horizontal's selected/expanded states with only preset shell deltas. Horizontal, baseline percentage tiers, disabled progress, and enabled messaging were restored through Admin and verified from active runtime assets. | `/private/tmp/fpb-feature-parity/F3/wpb/shared-mobile-footer/compact-horizontal-delta.md`, `tests/unit/assets/fpb-standard-mobile-summary-action.test.ts`, `test-spec/fpb-standard-mobile-summary-action.spec.md` |
...
| `F4-BOX-ALL` | EB and WPB fixed-amount Bundle Quantity Options used `Box of 2 -> ₹5` and `Box of 3 -> ₹10`. Underfill blocked progression, exact targets qualified the selected tier, overfill retained the highest qualified tier, upward switching retained selections, and switching down below the existing quantity was refused without clearing state. Standard, Classic, Compact, and Horizontal mobile replays rendered both targets without document overflow. WPB widget `5.0.215` added the shared downward-switch guard and the fixture returned to Horizontal. | Live direct Chrome DevTools MCP runtime, accessibility, interaction, geometry, asset, and network proof from 2026-07-30; `tests/unit/assets/fpb-box-selection-tier-switching.test.ts`; `tests/unit/assets/fpb-sidebar-discount-progress.test.ts`; `test-spec/fpb-mobile-box-selection.spec.md` |
| `F4-DEFAULTS-ALL` | The current App Bridge picker emitted canonical product and variant `id` GIDs. WPB previously dropped those IDs during Admin normalization, persisted zero quantity, and then expected obsolete `selectionId` fields in the storefront direct-default parser. The direct contract now persists `graphqlId`, `variantGraphqlId`, and `requiredQuantity: 1`. Cache-bypassed widget `5.0.216` replays initialized the same `$829.00` default once in Standard, Classic, Compact, and Horizontal, synchronized the footer rule delta to one remaining product, and retained zero document overflow. The rolling fixture remains Horizontal. | Live direct Chrome DevTools MCP Admin save payload, runtime config, served-asset source, accessibility, and mobile shopper state from 2026-07-30; `tests/unit/lib/default-products-contract.test.ts`; `tests/unit/assets/fpb-standard-mobile-summary-action.test.ts`; `test-spec/fpb-default-product-picker.spec.md` |
| `F4-INVALID-DEFAULT-ALL` | EB and WPB retained a configured default product/variant while that Shopify product was temporarily Draft. EB kept the stale ID in runtime configuration but omitted the product from its catalog, selection, and cart state without blocking the widget. WPB initially trusted its cached direct-default and step-product payloads. Widget `5.0.219` validates direct defaults through Storefront API hydration, prunes absent or unavailable variants from first-load selection, and removes matching stale cached cards. Standard, Classic, Compact, and Horizontal passed at `1280x800` and `390x844` with the configured ID retained, no selected state, no error, and zero document overflow. Both temporary Draft products were restored to Active; the rolling WPB fixture remains Horizontal. | Direct Chrome DevTools MCP Admin, runtime-config, Storefront API, accessibility, selection, geometry, and network proof from 2026-07-30; `/private/tmp/fpb-feature-parity/F4/invalid-default/delta.md`; `tests/unit/assets/fpb-standard-mobile-summary-action.test.ts`; `test-spec/fpb-standard-mobile-summary-action.spec.md` |
| `F5-COMPACT-VARIANTS-NAV` | The rich Compact fixture qualified its 100% add-on tier after the paid tier, then rendered five sellable Fragrance Candle variants individually in EB and WPB at `390x844` with zero document overflow. EB preserved Cherry as variant `45038881407172`, price `0`, and `_addonTierId: tier16804` across hard navigation away from and back to the add-on stage. WPB initially kept the active tier's saved individual-variant flag behind a populated step-product cache. Widget `5.0.222` refreshes active-tier presentation before the cache guard; the live dev-tunnel asset rendered Cherry, Vanilla, Lavendar, Orange, and Ocean as separate free cards. Cherry remained selected after navigating to Step 2 and back, and `/cart.js` preserved variant `48719984394499`, `_addon_product: true`, `_addonTierId: tier2`, `_bundle_step_type: addon:PERCENTAGE:100`, and the add-on offer ID. Core selections remained intact and the add-on slot did not displace them. | Direct Chrome DevTools MCP runtime config, interaction, geometry, selection, hard-navigation, and cart JSON proof from 2026-07-30; `tests/unit/assets/fpb-addon-active-tier-products.test.ts`; `test-spec/fpb-addon-tier-variant-presentation.spec.md`. |
| `F5-VARIANTS-NAV-ALL` | Reused the rich two-tier EB fixture and cycled WPB through Standard, Classic, Compact, and Horizontal on widget `5.0.222`. At `390x844`, every preset qualified the 100% tier, rendered Cherry, Vanilla, Lavendar, Orange, and Ocean as separate free Fragrance Candle cards with zero document overflow, retained Cherry after navigating to the preceding step and back, and kept core selections in their original slots. At `1280x800`, every preset loaded its matching template stylesheet and rendered the same five eligible variant cards without overflow. Compact cart proof retained variant `48719984394499`, free pricing, `_addon_product: true`, `_addonTierId: tier2`, `_bundle_step_type: addon:PERCENTAGE:100`, and the add-on offer ID; the add-on runtime and cart contract are shared across templates. Network responses for the widget, template stylesheet, language/controls settings, products, collections, and view event were `200`; console output contained no widget error. | Direct Chrome DevTools MCP mobile/desktop runtime, asset, geometry, interaction, navigation, console, network, and cart proof from 2026-07-30; `F5-MULTI-TIER-ALL`; `F5-COMPACT-VARIANTS-NAV`. |
| `F5-GIFTING-ONLY-ALL` | EB and WPB retained the rich saved add-on tiers while the add-on-product control was disabled and the personalization stage remained enabled. Standard, Classic, Compact, and Horizontal each persisted the enabled personalization contract, omitted add-on qualification messaging, rendered the `Add On` stage after both product steps, and stayed within the `390x844` viewport. WPB served widget `5.0.222` and the matching preset stylesheet in every replay. | Direct Chrome DevTools MCP Admin persistence, cache-bypassed mobile runtime, asset, navigation, and geometry proof from 2026-07-30. |
...
| `F6-DESIGN` | EB persisted and replayed the complete design fixture through Standard, Classic, Compact, and Horizontal: brand and expert colors, typography, corners, image fit, scoped CSS, desktop/mobile banners, and locale-aware copy remained document-contained at desktop and mobile widths. WPB persisted the equivalent global Design and Controls settings through successful `/app/settings.data` requests, while existing bundles intentionally retain their synchronized design snapshot until the merchant runs Sync Bundle. The rolling pre-sync bundle therefore kept its prior typography, CTA colors, and scoped CSS state after cache-bypassed reload; affected cells are terminal `X` for this explicit product-level synchronization divergence rather than false parity. Loading media remains directly proven across presets, and WPB's nullable per-bundle timeline override is an additional accepted divergence because EB exposes no equivalent direct override. | Direct Chrome DevTools MCP Admin persistence, preset identity, cache-bypassed desktop/mobile runtime, computed styles, responsive banner selection, overflow, accessibility, console, and network proof from 2026-07-30. |
| `F7-CART-CONTROLS` | Combined current and prior direct all-preset cart evidence closes blocked/success flows, add-on pricing and metadata, merged `bundle_details`, transformed totals, inventory gating, redirect outcomes, cart-line messaging, and the one-shot Landing Page script lifecycle. The final live Horizontal amount-only replay produced one transformed `Daily Essentials` parent line with four component identities, `$2606.00` retail, `$10.00` savings, `$2596.00` final, and `You Save: $10.00` after a cart recalculation. Root cause was an exact Function enum mismatch: Admin persists `amount_only` and `percentage_only`, while Rust matched `amount` and `percentage`; focused red/green integration tests now lock both persisted values. | Direct Chrome DevTools MCP Settings save request, Controls API response, qualified storefront/cart interactions, `/cart/add.js`, `/cart/change.js`, `/cart.js`, checkout, session storage, and live dev Function replay from 2026-07-30; `extensions/bundle-cart-transform-rs/src/merge.rs`; `extensions/bundle-cart-transform-rs/tests/integration_test.rs`; `test-spec/cart-transform-savings-format.spec.md`; `tests/unit/assets/fpb-post-add-controls.test.ts`; `test-spec/fpb-post-add-controls.spec.md`. |
