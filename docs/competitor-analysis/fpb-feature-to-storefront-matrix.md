...
| A03 | F5 | Paid add-on tier | Eligible shopper can add the paid add-on at the configured price | **P** P09 | **S** | **P** F5-COMPACT-VARIANTS-NAV | **P** C06 |
| A04 | F5 | Free/100% add-on tier | Eligible item becomes free at the configured threshold | **P** P10 | **S** | **P** F5-COMPACT-VARIANTS-NAV | **P** C06 |
...
| A07 | F5 | Add-on product variants | Variant identity and price survive add/remove and cart add | **S** | **S** | **P** F5-COMPACT-VARIANTS-NAV | **T** |
| A08 | F5 | Add-on step navigation | Back/Next preserves core selections and add-on state | **S** | **S** | **P** F5-COMPACT-VARIANTS-NAV | **P** C06 |
| A09 | F5 | Free-gift/sidebar presentation | Gift appears at the EB-owned summary/footer position | **S** | **S** | **P** F5-COMPACT-VARIANTS-NAV | **T** |
...
| A15 | F5 | Sidebar add-on/upsell slot | Configured upsell appears only at the EB-owned summary stage and does not displace core selections | **S** | **S** | **P** F5-COMPACT-VARIANTS-NAV | **T** |
