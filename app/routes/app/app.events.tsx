...
const LATEST_EVENTS = [
  {
    ...
    subtitle:
      "Full-page bundles now load instantly — no app proxy round-trip on first paint.",
    badge: "v2.3.0",
    badgeColor: "#e6f4ea",
    ...
    content: (
      <s-stack direction="block" gap="base">
        ...
        <s-stack direction="block" gap="small-100">
          ...
          <p style={{ margin: 0, fontSize: 13, color: "#6d7175" }}>
            Your full-page bundles now appear instantly when a customer visits
            the page — no more loading spinner while the bundle content loads
            in.
          </p>
        </s-stack>
        <s-stack direction="block" gap="small-100">
          ...
          <p style={{ margin: 0, fontSize: 13, color: "#6d7175" }}>
            ...
            Customers see your bundle immediately, which reduces drop-off before
        ...
        <s-stack direction="block" gap="small-100">
          ...
          <p style={{ margin: 0, fontSize: 13, color: "#6d7175" }}>
            For any full-page bundles you set up before this update, open the
            bundle and click <strong>Sync Bundle</strong> once. That&apos;s it —
            bundles you create going forward are already covered.
          </p>
        </s-stack>
      </s-stack>
    ),
...
const FAQS_AND_TUTORIALS = [
  {
    ...
    subtitle:
      "Hide internal bundle properties from your cart page on custom themes.",
...
export default function EventsPage() {
  ...
  return (
    <>
      <AdminPageTitleBar
        title={translateAdmin("nav.events")}
      ...
      <s-query-container containerName="events-page">
        <div className={styles.pageShell}>
          ...
          <s-stack direction="block" gap="large">
            ...
            <s-stack direction="block" gap="base">
              <SectionHeader
                title={translateAdmin("adminAttributes.latestUpdates")}
            ...
            <s-stack direction="block" gap="base">
              <SectionHeader
                title={translateAdmin("adminAttributes.faqsTutorials")}
