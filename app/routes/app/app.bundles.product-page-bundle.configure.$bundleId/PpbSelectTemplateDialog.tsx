        ...
        {templateModalStep === "templates" ? (
                ...
                {productPageTemplateOptions.map((templateOption) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={productPageBundleStyles.templateOptionFooter}
                      >
                        <span
                          className={
          ...
          <>
            <div className={productPageBundleStyles.templateDialogBody}>
              ...
              >
                <div
                  className={productPageBundleStyles.templateCustomizationCard}
                >
                  <h4>Brand colors</h4>
                  <p>
          ...
          <div className={productPageBundleStyles.templateDialogBody}>
            <div
              className={productPageBundleStyles.templateDialogConfirmHeader}
            >
              <h3 className={productPageBundleStyles.templateDialogSubheading}>
                Enable your preview
              </h3>
