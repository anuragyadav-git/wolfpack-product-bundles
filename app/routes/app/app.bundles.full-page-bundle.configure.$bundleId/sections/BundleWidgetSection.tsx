      ...
      {activeSection === "bundle_widget" && (
        <div data-tour-target="fpb-bundle-widget">
          <div className={fullPageBundleStyles.visibilityPanel}>
            ...
            <DisabledConfigurationRegion disabled={!upsellWidgetEnabled}>
              <div className={fullPageBundleStyles.upsellWidgetContent}>
                  ...
                  <div className={fullPageBundleStyles.visibilityRadioBar}>
                    ...
                    >
                      <s-choice-list
                        ...
                        values={
                          upsellWidgetDisplayMode === "block" ? ["block"] : []
                        }
                      ...
                      <s-choice-list
                        ...
                        values={
                          upsellWidgetDisplayMode === "button" ? ["button"] : []
                        }
                        disabled={!upsellWidgetEnabled || undefined}
                        onChange={handleWidgetTypeChange}
                      >
                ...
                <div className={fullPageBundleStyles.visibilityPanelSection}>
                  <div className={fullPageBundleStyles.visibilitySectionHeader}>
                    ...
                    <s-button
                      ...
                      disabled={
                        !upsellWidgetEnabled ||
                        isMultiLanguageActionDisabled(shopLocales) ||
                        undefined
                      }
                      onClick={() =>
                  ...
                  <div className={fullPageBundleStyles.visibilityFieldStack}>
                    {upsellWidgetDisplayMode !== "button" && (
                      <div
                        className={fullPageBundleStyles.upsellBlockFieldsRow}
                      >
                        <div
                          className={fullPageBundleStyles.upsellBlockImageField}
                        >
                          <FilePicker
                            label="Widget image"
                        ...
                        <div
                          className={fullPageBundleStyles.upsellBlockCopyFields}
                        >
                          <s-text-field
                ...
                <div className={fullPageBundleStyles.visibilityPanelSection}>
                  ...
                  >
                    ...
                    <s-choice value="specific_products">
                      Specific products
                    </s-choice>
                    <s-choice value="specific_collections">
                      Specific collections
                    </s-choice>
                  </s-choice-list>
                  {upsellWidgetDisplayOn === "specific_products" && (
                    <div
                      className={fullPageBundleStyles.visibilityTargetPicker}
                    >
                      <s-button
                        variant="secondary"
                        disabled={!upsellWidgetEnabled || undefined}
                  ...
                  {upsellWidgetDisplayOn === "specific_collections" && (
                    ...
                    >
                      ...
                      {validationErrors["widget.collections"] && (
                        <s-text
                          id="configure-widget-collections"
                          tone="critical"
                        >
                          {validationErrors["widget.collections"]}
                        </s-text>
          ...
          <DisabledConfigurationRegion disabled={!upsellWidgetEnabled}>
            <div className={fullPageBundleStyles.visibilityPlacementCard}>
              <div>
                ...
                <p className={fullPageBundleStyles.visibilityCardText}>
                  By default, the upsell is added below the Buy Button. You can
                  move it to a custom spot on the product page if you prefer.
                </p>
              </div>
              <s-button
                variant="secondary"
