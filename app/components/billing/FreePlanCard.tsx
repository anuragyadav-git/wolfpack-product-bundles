            ...
            <s-stack direction="block" gap="large">
              <s-stack direction="block" gap="small-100">
                ...
                <s-stack direction="inline" alignItems="baseline" gap="small-400">
                  <span className={brandStyles.price}>{t("billing.cards.freePrice")}</span>
                </s-stack>
              ...
              <s-stack direction="block" gap="small">
                <p className={brandStyles.featureHeading}>{t("billing.cards.includes")}</p>
                <s-stack direction="block" gap="small-100">
                  {PLANS.free.featureMessageIds.map((messageId) => (
                    <s-stack key={messageId} direction="inline" alignItems="center" gap="small-100">
                      ...
                      <span className={brandStyles.feature}>{t(messageId)}</span>
                    </s-stack>
                  ))}
                </s-stack>
              </s-stack>
