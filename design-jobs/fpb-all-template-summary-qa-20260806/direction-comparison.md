...
source_paths:
  - design-jobs/fpb-all-template-summary-qa-20260806/visual-audit.md
  - design-jobs/fpb-all-template-summary-qa-20260806/screenshot-inventory.yaml
related_docs:
...
- Strengths: Reuses the shared state path; preserves preset identity; directly addresses GAP-01 through GAP-08; inherits the already approved Classic direction; smallest behavior risk; strongest consistency under the full matrix.
...
- Tradeoffs: Encourages duplicate markup or branching; multiplies matrix permutations; risks behavior drift; conflicts with repository-observed shared render ownership; makes accessibility fixes easy to apply unevenly.
